...
export default function LogDashboardPage({ params }: { params: Promise<{ id: string }> }) {
    return (
        <Suspense
            fallback={
...
async function LogDashboardInner({ params }: { params: Promise<{ id: string }> }) {
    await connection();
        ...
        <div className="container mx-auto p-8 max-w-5xl">
            <div className="mb-4">
                ...
                <div className="flex justify-between items-center bg-slate-900 border-border text-slate-100 p-6 rounded-lg shadow-sm border mb-8">
                    <div>
                        <h1 className="text-3xl font-bold">{classData.name} - System Log</h1>
