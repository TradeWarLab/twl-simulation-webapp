...
import { submitVote, getVotesForProposal } from "@/app/actions/trade-controller";
                    ...
                    <div className="rounded-lg border bg-slate-50 dark:bg-slate-900 p-3">
                        ...
                        <div className="flex gap-4 mb-2">
                            <div className="flex-1 text-center">
                                <div className="text-2xl font-bold text-emerald-600">{approvals}</div>
                            ...
                            <div className="flex-1 text-center">
                                <div className="text-2xl font-bold text-red-500">{rejections}</div>
                                <div className="text-[10px] text-muted-foreground uppercase tracking-wide">
                                    Reject
                                </div>
                            </div>
                        ...
                        <p className="text-[10px] text-muted-foreground text-center mt-1">
                            {votes.length} / {proposal.vote_summary?.total_members ?? "?"} members voted
                        </p>
                    </div>
