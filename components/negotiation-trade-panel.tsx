...
export function NegotiationTradePanel({
    ...
    const [activeDragItem, setActiveDragItem] = useState<TradeItemWithTeam | null>(null);
    ...
    const opponentAvailableItems = opponentItems.filter((i) => !requestedItemIds.has(i.id));
    const opponentRequestedItems = opponentItems.filter((i) => requestedItemIds.has(i.id));
    ...
    function handleDragEnd(event: DragEndEvent) {
        ...
        } else if (overId === "opponent-trade-zone" && draggedItem.team_id === opponentTeamId) {
                ...
                <div className="flex-1 grid grid-cols-2 gap-3 min-h-0">
                    ...
                    <div className="flex flex-col gap-3 min-h-0">
                        ...
                        <div className="flex items-center justify-between px-3 py-2 rounded-lg bg-gradient-to-r from-blue-500/10 to-blue-600/5 dark:from-blue-500/20 dark:to-blue-600/10 border border-blue-200/50 dark:border-blue-800/50">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="font-semibold text-sm">Team {myTeamCountry}</span>
                    ...
                    <div className="flex flex-col gap-3 min-h-0">
                        ...
                        <div className="flex items-center justify-between px-3 py-2 rounded-lg bg-gradient-to-r from-red-500/10 to-red-600/5 dark:from-red-500/20 dark:to-red-600/10 border border-red-200/50 dark:border-red-800/50">
                            <div className="flex items-center gap-2">
                                <span className="text-lg">{flagEmoji(opponentTeamCountry)}</span>
